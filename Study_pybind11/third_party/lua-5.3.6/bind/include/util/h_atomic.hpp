...
//CompareAndSwap
static inline int h_atomic_cas(int volatile *a, int oldvalue, int newvalue)
{
#if defined(USE_C11_ATOMICS)
...
static inline int h_atomic_add(int volatile *a, int value){
#if defined(USE_C11_ATOMICS)
...
static inline int h_atomic_get(int volatile *a)
{
#if defined(USE_C11_ATOMICS)
...
static inline void h_atomic_set(int volatile *a, int newvalue)
{
#if defined(USE_C11_ATOMICS)
